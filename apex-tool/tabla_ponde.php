...
<head>
    <title>Tabla promoción poderado</title>
    <meta charset="UTF-8">
...
<body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <header class="w3-container" style="padding-top:22px">
            <button type="button" onclick="location.href='GeneraPonde.php'" style="float:right;border:none;cursor: pointer;"><i class="fa fa-file-excel-o" style="font-size: 30px;color:green;position: relative;"></i></i></button>
            <h5><b><i class="fa fa-dashboard"></i> Tabla promoción poderado</b></h5>

        </header>

        <div class="w3-container">

        <h2>CON PROMOCIÓN PONDERADO</h2>
            <div class="w3-responsive">
                <table class="w3-table-all w3-card-4">
                    <tr>
                        <th>Familia</th>
                        <th>Apex vs Promedio</th>
                        <th>Apex vs Min</th>
                        <th>Apex vs Max</th>
