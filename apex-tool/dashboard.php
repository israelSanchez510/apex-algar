...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:250px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="#" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Tabla Dif</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-panel" id="respuesta" style="margin-top: 50px">
...
<script>
    ...
    $('#guardarC').click(function () {
        ...
        var valores =
            "valor=1&distribuidor=" + distribuidor + "&SKU=" + sku
            + "&fecha1=" + precio + "&fecha2=" + posicSata + "&nombreMercado=" + promocion ;
        //
        //
