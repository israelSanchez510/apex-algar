...
<head>
    <title>Grafico Posicion SATA</title>
    <meta charset="UTF-8">
...
<div class="w3-container w3-row">
    ...
    <div class="w3-bar-block">
        ...
        <a href="#" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Grafico posicion SATA</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i> Grafico posicion SATA</b></h5>
    </header>
    ...
    <div class="w3-row-padding w3-margin-bottom">
        ...
        <div class="w3-half">
            <div id="grafico" class="w3-panel">
                <canvas id="grafico1" style="width:50% height=400px"></canvas>
            </div>
        </div>
        <div class="w3-quarter">
            <p></p>
...
<script>
    ...
    $('#guardarC').click(function () {
        ...
        var valores =
            "valor=5&distribuidor=" + distribuidor + "&SKU=" + sku
                ...
                myChart = new Chart(ctx,
                    {
                        ...
                        data:{
                            ...
                            datasets:
                                [{
                                    label: "Posicion SATA",
                                    data:[data.uno,data.dos,data.tres,data.cuatro],
                                    backgroundColor:[
                                        'rgb(66,134,244)',
                                        'rgb(74,135,72)',
                                        'rgb(201,255,229)',
